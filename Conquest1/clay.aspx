<%@ Page Title="" Language="C#" MasterPageFile="~/village.Master" AutoEventWireup="true" CodeBehind="clay.aspx.cs" Inherits="Conquest1.clay" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="overview">
        <div id="content">
            <h3>KİL MADENİ (Seviye <asp:Label ID="lblseviye" runat="server" Text=""></asp:Label>&nbsp;)</h3>
            <br />
            Kil ocağında işçilerin, köyünü kurmak için önemli olan kili çıkarırlar. Kil ocağının seviyesi ne kadar yüksekse o kadar çok kil çıkarılır.
            <br />&nbsp
