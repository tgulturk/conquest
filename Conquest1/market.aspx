...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="overview">
        ...
        <table>
            <tr>
                <td><asp:Label ID="Label3" runat="server" Text="Odun :" Height="24px" Width="55px"></asp:Label></td>
                <td>
            ...
            <tr>
                <td><asp:Label ID="Label9" runat="server" Text="Kil :" Height="24px" Width="55px"></asp:Label></td>
                <td>
                ...
                <td><asp:Label ID="Label1" runat="server" Width="60px" Text=" " Height="24px"></asp:Label></td>
                <td>
            ...
            <tr>
                <td><asp:Label ID="Label2" runat="server" Text="Demir :" Height="24px" Width="55px"></asp:Label></td>
                <td><asp:TextBox ID="tbDemir" runat="server" Width="75px" 
                ...
                <asp:Repeater ID="rep1" runat="server">
                    <HeaderTemplate>
                        <table style=" border:1px solid white; background-color:#C1A264">
                            <tr >
                                ...
                                <td style="width:60px"><asp:Label ID="Label10" runat="server" Width="60px" Text="Odun" Font-Bold="True" Font-Size="Small"></asp:Label></td>
                                <td style="width:60px"><asp:Label ID="Label11" runat="server" Width="60px" Text="Kil" Font-Bold="True" Font-Size="Small"></asp:Label></td>
                                <td style="width:60px"><asp:Label ID="Label12" runat="server" Width="60px" Text="Demir" Font-Bold="True" Font-Size="Small"></asp:Label></td>
                                <td style="width:60px"><asp:Label ID="Label1" runat="server" Width="60px" Text="Tüccar" Font-Bold="True" Font-Size="Small"></asp:Label></td>
                    ...
                    <ItemTemplate>
                        <table style=" border:1px solid white; background-color:#F4E4BC">
                            <tr >
                                <td style="width:160px"><asp:Label ID="lb1" runat="server" Width="160px" Text='<%#Eval("vName")%>' Font-Size="Small"></asp:Label></td>
                                <td style="width:60px"><asp:Label ID="Label13" runat="server" Width="60px" Text='<%#Eval("odun")%>'  Font-Size="Small"></asp:Label></td>
                                <td style="width:60px"><asp:Label ID="Label14" runat="server" Width="60px" Text='<%#Eval("kil")%>'  Font-Size="Small"></asp:Label></td>
                                <td style="width:60px"><asp:Label ID="Label15" runat="server" Width="60px" Text='<%#Eval("demir")%>'  Font-Size="Small"></asp:Label></td>
                                <td style="width:60px"><asp:Label ID="Label1" runat="server" Width="60px" Text='<%#Eval("mCount")%>'  Font-Size="Small"></asp:Label></td>
